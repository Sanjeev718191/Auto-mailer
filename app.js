...
const recipients1 = [
    ...
    { name: 'Manish Sharma', email: 'manish.sharma@zypp.app', company: 'Zypp Electric' },
    { name: 'George Shende', email: 'george.shende@zypp.app', company: 'Zypp Electric' },
    { name: 'Kunal Thakur', email: 'kunal.thakur@zypp.app', company: 'Zypp Electric' },
    { name: 'Saumya Mendiratta', email: 'saumya.mendiratta@zypp.app', company: 'Zypp Electric' },
    { name: 'Zeba Siddiqui', email: 'zeba.siddiqui@zypp.app', company: 'Zypp Electric' },
    { name: 'Gaurav Jha', email: 'gaurav.jha@zypp.app', company: 'Zypp Electric' },
    { name: 'Raju A', email: 'raju.a@zypp.app', company: 'Zypp Electric' },
    { name: 'Amit Jeena', email: 'amit.jeena@zypp.app', company: 'Zypp Electric' },
    { name: 'Isha Singh', email: 'isha.singh@zypp.app', company: 'Zypp Electric' },
    { name: 'Ayush Dhiman', email: 'ayushdhiman@zypp.app', company: 'Zypp Electric' },
    { name: 'Rahul Chauhan', email: 'rahul.chauhan@zypp.app', company: 'Zypp Electric' },
    { name: 'Ashish Gupta', email: 'ashish.gupta@zypp.app', company: 'Zypp Electric' },
];
