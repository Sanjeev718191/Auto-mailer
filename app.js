...
const recipients1 = [
    ...
    { name: 'Shivam Tomar', email: 'shivam.tomar@razorpay.com', company: 'Razorpay' },
    { name: 'Pravir Shanker', email: 'pravir.shanker@razorpay.com', company: 'Razorpay' },
    { name: 'Shashank Kumar', email: 'shashank.kumar@razorpay.com', company: 'Razorpay' },
    { name: 'Harshil Mathur', email: 'harshil@razorpay.com', company: 'Razorpay' },
    { name: 'Sumit Premi', email: 'sumit.premi@razorpay.com', company: 'Razorpay' },
    { name: 'Prakhar Gupta', email: 'prakhar.g@razorpay.com', company: 'Razorpay' },
    { name: 'Shivangi Sinha', email: 'shivangi.sinha@razorpay.com', company: 'Razorpay' },
    { name: 'Nandini Nair', email: 'nandini.nair@razorpay.com', company: 'Razorpay' },
    { name: 'Supriya S', email: 'supriya.s@razorpay.com', company: 'Razorpay' },
    { name: 'Gaurav Dadhich', email: 'gaurav.dadhich@razorpay.com', company: 'Razorpay' },
    { name: 'Shubham Bisht', email: 'shubham.bisht@razorpay.com', company: 'Razorpay' },
    { name: 'Trisha Arya', email: 'trisha.arya@razorpay.com', company: 'Razorpay' },
    { name: 'Akhil Sharma', email: 'akhil.s@razorpay.com', company: 'Razorpay' },
    { name: 'Naman Goyal', email: 'naman.goyal@razorpay.com', company: 'Razorpay' },
    { name: 'Arpith Ashok', email: 'arpith.ashok@razorpay.com', company: 'Razorpay' },
    { name: 'Anshul Saluja', email: 'anshul.saluja@razorpay.com', company: 'Razorpay' },
    { name: 'Nishitha Kuriyas', email: 'nishitha.kuriyas@razorpay.com', company: 'Razorpay' },
    { name: 'Shivani P', email: 'shivani.patil@razorpay.com', company: 'Razorpay' },
    { name: 'Jagrathi Wj', email: 'jagrathi.wj@razorpay.com', company: 'Razorpay' },
    { name: 'Ayushi Chaudhary', email: 'ayushi.chaudhary@razorpay.com', company: 'Razorpay' },
    { name: 'Mohita Tiwari', email: 'mohita.tiwari@razorpay.com', company: 'Razorpay' },
    { name: 'Saket Khanna', email: 'saket.khanna@razorpay.com', company: 'Razorpay' },
    { name: 'Anvay Nagarkatti', email: 'anvay.nagarkatti@razorpay.com', company: 'Razorpay' },
    { name: 'Deeksha Shetty', email: 'deeksha.shetty@razorpay.com', company: 'Razorpay' },
    { name: 'Shilpa Mittal', email: 'shilpa.mittal@razorpay.com', company: 'Razorpay' },
    { name: 'Gaurang Patel', email: 'gaurang.patel@razorpay.com', company: 'Razorpay' },
    { name: 'Nishant Dayal', email: 'nishant.dayal@razorpay.com', company: 'Razorpay' },
    { name: 'Rajashree Khandelia', email: 'rajashree.khandelia@razorpay.com', company: 'Razorpay' },
    { name: 'Rajat Agarwal', email: 'rajat.agarwal@razorpay.com', company: 'Razorpay' },
    { name: 'Gyanendra Singh', email: 'gyanendra.singh@razorpay.com', company: 'Razorpay' },
    { name: 'Nikhil Sharma', email: 'sharma.nikhil@razorpay.com', company: 'Razorpay' },
    { name: 'Anil Kumar', email: 'anil.k@sharechat.co', company: 'ShareChat' },
    { name: 'Antariksh Chavan', email: 'antariksh@sharechat.com', company: 'ShareChat' },
    { name: 'Malay Shah', email: 'malayshah@sharechat.co', company: 'ShareChat' },
    { name: 'Shivam Tiwari', email: 'shivamtiwari@sharechat.com', company: 'ShareChat' },
    { name: 'Amit Z', email: 'amit.z@sharechat.com', company: 'ShareChat' },
    { name: 'Saira Mohammed', email: 'saira@sharechat.co', company: 'ShareChat' },
    { name: 'Sandip Mohanty', email: 'sandipani@sharechat.co', company: 'ShareChat' },
    { name: 'Shruthi Aravelli', email: 'shruthiaravelli@sharechat.com', company: 'ShareChat' },
    { name: 'Shubham Dhal', email: 'shubhamdhal@sharechat.com', company: 'ShareChat' },
    { name: 'Anita Choudhry', email: 'anita@sharechat.co', company: 'ShareChat' },
    { name: 'Azitabh Ajit', email: 'azitabh@sharechat.co', company: 'ShareChat' },
    { name: 'Himanshu Pandey', email: 'himanshu@sharechat.co', company: 'ShareChat' },
    { name: 'Mahek Mahtta', email: 'mahekmahtta@sharechat.com', company: 'ShareChat' },
    { name: 'Soumya Gaonkar', email: 'soumyagaonkar@sharechat.com', company: 'ShareChat' },
    { name: 'Nagaraj Rayudu', email: 'nagarajrayudu@sharechat.com', company: 'ShareChat' },
    { name: 'Shubham Choudhary', email: 'shubhamchoudhary@sharechat.com', company: 'ShareChat' },
    { name: 'Hament Miglani', email: 'hamentmiglani@sharechat.com', company: 'ShareChat' },
    { name: 'Gaurav Bhandarkar', email: 'gauravbhandarkar@sharechat.com', company: 'ShareChat' },
    { name: 'Gitesh Narula', email: 'gitesh@sharechat.co', company: 'ShareChat' },
    { name: 'Vivek Kumar', email: 'vivek.kumar@sharechat.co', company: 'ShareChat' },
    { name: 'Suhrid Mathur', email: 'suhridmathur@sharechat.co', company: 'ShareChat' },
    { name: 'Devesh Sharma', email: 'sharmadevesh@microsoft.com', company: 'Microsoft' },
    { name: 'Devesh Sharma', email: 'sharmadevesh360@gmail.com', company: 'Microsoft' },
    { name: 'Vinay Kruttiventi', email: 'vinay@a5corp.com', company: 'A5' },
];
